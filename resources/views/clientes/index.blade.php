...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-1">
        <form method="POST" id="deleteForm" action="{{ route('clientes.destroy', 0)  }}">
        @csrf
        @method('DELETE')
        ...
        <div class="col-md-1">
            <div class="input-group">
                <a href="{{ url('/clientes/create') }}" class="btn btn-primary" aria-label="Add" title="Agregar">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-person-fill-add" viewBox="0 0 16 16" aria-hidden="true">
        ...
        <table class="table table-striped table-hover table-borderless">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="deleteId[]" value="{{ $cliente->id }}" aria-label="Select ID {{ $cliente->id }}"></td>
    ...
    <div class="row">
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                ...
                ])><a class="page-link" href="/clientes?page={{ $i }}{{ ($querystring != '') ? '&query=' . $querystring : '' }}">{{ $i }}</a></li>
                @endfor
